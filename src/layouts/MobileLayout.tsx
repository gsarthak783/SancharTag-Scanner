...
export const MobileLayout: React.FC<MobileLayoutProps> = ({ children, className = '' }) => {
    return (
        <div className="h-screen bg-surface flex justify-center text-text-primary font-sans antialiased selection:bg-black/10">
            <div className={`w-full max-w-md h-full shadow-2xl flex flex-col relative overflow-hidden bg-background border-x border-border ${className}`}>
